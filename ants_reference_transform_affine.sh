...
# @Last Modified time: 2021-06-01 10:36:04
...
transform_refenced ()
{
    ...
    echo;
    echo "python transform_referenced_ants_affine.py -v $2/$1/fractions/$1_fraction00.nrrd \
        $2/$1/doses/ $3/$1/ants/ $3/$1/"
    echo;
    python transform_referenced_ants_affine.py -v $2/$1/fractions/$1_fraction00.nrrd \
        $2/$1/doses $3/$1/ants/ $3/$1
}
